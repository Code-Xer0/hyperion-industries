...
(() => {
  // Absolute path so the sidecar lives in one place regardless of which
  // HTML loads this component (public /dxcard/ vs editor /edit.html).
  const STATE_FILE = '/assets/card/.image-slots.state.json';
