import { F as e, R as t, v as n, z as r } from "./Geometry-uzK7Lbb5.js";
import { i, r as a, v as o } from "./Filter-BHocqa2Q.js";
...
var G = 2048, K = new e(), q = new e(), J = class {
	constructor(e) {
		this.dispatch = new t(), this.moveOnAll = !1, this.enableGlobalMoveEvents = !0, this.mappingState = { trackingData: {} }, this.eventPool = /* @__PURE__ */ new Map(), this._allInteractiveElements = [], this._hitElements = [], this._isPointerMoveEvent = !1, this.rootTarget = e, this.hitPruneFn = this.hitPruneFn.bind(this), this.hitTestFn = this.hitTestFn.bind(this), this.mapPointerDown = this.mapPointerDown.bind(this), this.mapPointerMove = this.mapPointerMove.bind(this), this.mapPointerOut = this.mapPointerOut.bind(this), this.mapPointerOver = this.mapPointerOver.bind(this), this.mapPointerUp = this.mapPointerUp.bind(this), this.mapPointerUpOutside = this.mapPointerUpOutside.bind(this), this.mapWheel = this.mapWheel.bind(this), this.mappingTable = {}, this.addEventMapping("pointerdown", this.mapPointerDown), this.addEventMapping("pointermove", this.mapPointerMove), this.addEventMapping("pointerout", this.mapPointerOut), this.addEventMapping("pointerleave", this.mapPointerOut), this.addEventMapping("pointerover", this.mapPointerOver), this.addEventMapping("pointerup", this.mapPointerUp), this.addEventMapping("pointerupoutside", this.mapPointerUpOutside), this.addEventMapping("wheel", this.mapWheel);
	}
	addEventMapping(e, t) {
	...
	mapPointerMove(e) {
		...
		let r = t.pointerType === "mouse" || t.pointerType === "pen", i = this.trackingData(e.pointerId), a = this.findMountedTarget(i.overTargets);
		if (i.overTargets?.length > 0 && a !== t.target) {
			let n = e.type === "mousemove" ? "mouseout" : "pointerout", i = this.createPointerEvent(e, n, a);
			if (this.dispatchEvent(i, "pointerout"), r && this.dispatchEvent(i, "mouseout"), !t.composedPath().includes(a)) {
				let n = this.createPointerEvent(e, "pointerleave", a);
				for (n.eventPhase = n.AT_TARGET; n.target && !t.composedPath().includes(n.target);) n.currentTarget = n.target, this.notifyTarget(n), r && this.notifyTarget(n, "mouseleave"), n.target = n.target.parent;
				this.freeEvent(n);
			}
			this.freeEvent(i);
		}
		if (a !== t.target) {
			let n = e.type === "mousemove" ? "mouseover" : "pointerover", i = this.clonePointerEvent(t, n);
		...
		this.moveOnAll ? o.push("pointermove") : this.dispatchEvent(t, "pointermove"), s && o.push("globalpointermove"), t.pointerType === "touch" && (this.moveOnAll ? o.splice(1, 0, "touchmove") : this.dispatchEvent(t, "touchmove"), s && o.push("globaltouchmove")), r && (this.moveOnAll ? o.splice(1, 0, "mousemove") : this.dispatchEvent(t, "mousemove"), s && o.push("globalmousemove"), this.cursor = t.target?.cursor), o.length > 0 && this.all(t, o), this._allInteractiveElements.length = 0, this._hitElements.length = 0, i.overTargets = t.composedPath(), this.freeEvent(t);
	}
	mapPointerOver(e) {
		if (!(e instanceof U)) {
			n("EventBoundary cannot map a non-pointer event as a pointer event");
		...
		let t = this.trackingData(e.pointerId), r = this.createPointerEvent(e), i = r.pointerType === "mouse" || r.pointerType === "pen";
		...
		t.overTargets = r.composedPath(), this.freeEvent(r), this.freeEvent(a);
	}
	mapPointerOut(e) {
		if (!(e instanceof U)) {
			n("EventBoundary cannot map a non-pointer event as a pointer event");
	...
	mapPointerUp(e) {
		...
		let t = performance.now(), r = this.createPointerEvent(e);
		...
		if (o) {
			let n = this.clonePointerEvent(r, "click");
			n.target = o, n.path = null, i.clicksByButton[e.button] || (i.clicksByButton[e.button] = {
				clickCount: 0,
				target: n.target,
				timeStamp: t
			});
			let a = i.clicksByButton[e.button];
			if (a.target === n.target && t - a.timeStamp < 200 ? ++a.clickCount : a.clickCount = 1, a.target = n.target, a.timeStamp = t, n.detail = a.clickCount, n.pointerType === "mouse") {
				let e = n.button === 2;
				this.dispatchEvent(n, e ? "rightclick" : "click");
			} else n.pointerType === "touch" && this.dispatchEvent(n, "tap");
	...
	mapPointerUpOutside(e) {
		...
		let t = this.trackingData(e.pointerId), r = this.findMountedTarget(t.pressTargetsByButton[e.button]), i = this.createPointerEvent(e);
		if (r) {
			let n = r;
