import { B as e, F as t, M as n, O as r, P as i, R as a, S as o, T as s, _ as c, a as l, b as u, c as d, g as f, j as p, k as m, o as h, p as g, s as ee, u as te, v as ne, w as _, x as v, y, z as b } from "./Geometry-uzK7Lbb5.js";
import { _ as re, a as x, c as S, d as ie, l as ae, m as oe, n as se, o as ce, p as le, r as C, t as ue, u as w } from "./Filter-BHocqa2Q.js";
import { n as de, p as T } from "./GCManagedHash-im6pMy80.js";
//#region node_modules/pixi.js/lib/environment/autoDetectEnvironment.mjs
var E = [];
e.handleByNamedList(b.Environment, E);
async function fe(e) {
	if (!e) for (let e = 0; e < E.length; e++) {
		let t = E[e];
		if (t.value.test()) {
			await t.value.load();
			return;
...
var O = /* @__PURE__ */ ((e) => (e[e.NONE = 0] = "NONE", e[e.COLOR = 16384] = "COLOR", e[e.STENCIL = 1024] = "STENCIL", e[e.DEPTH = 256] = "DEPTH", e[e.COLOR_DEPTH = 16640] = "COLOR_DEPTH", e[e.COLOR_STENCIL = 17408] = "COLOR_STENCIL", e[e.DEPTH_STENCIL = 1280] = "DEPTH_STENCIL", e[e.ALL = 17664] = "ALL", e))(O || {}), me = class {
	constructor(e) {
	...
	async init(t = {}) {
		await fe(t.skipExtensionImports === !0 ? !0 : t.manageImports === !1), this._addSystems(this.config.systems), this._addPipes(this.config.renderPipes, this.config.renderPipeAdaptors);
	...
	render(e, t) {
		this.tick++;
		let n = e;
		if (n instanceof S && (n = { container: n }, t && (r(m, "passing a second argument is deprecated, please use render options instead"), n.target = t.renderTexture)), n.target ||= this.view.renderTarget, n.target === this.view.renderTarget && (this._lastObjectRendered = n.container, n.clearColor ??= this.background.colorRgba, n.clear ??= this.background.clearBeforeRender), n.clearColor) {
	...
	_unsafeEvalCheck() {
		if (!pe()) throw Error("Current environment does not allow unsafe-eval, please use pixi.js/unsafe-eval module to enable support.");
	}
	resetState() {
...
var _e = ge, k = "8.19.0", ve = class {
	static init() {
		globalThis.__PIXI_APP_INIT__?.(this, k);
	}
	static destroy() {}
};
ve.extension = b.Application;
var ye = class {
	constructor(e) {
		this._renderer = e;
	}
	init() {
		globalThis.__PIXI_RENDERER_INIT__?.(this._renderer, k);
	}
	destroy() {
		this._renderer = null;
	}
...
var M = class {
	...
	constructor(e, t) {
		this.state = se.for2d(), this._batchersByInstructionSet = /* @__PURE__ */ Object.create(null), this._activeBatches = /* @__PURE__ */ Object.create(null), this.renderer = e, this._adaptor = t, this._adaptor.init?.(this);
	}
...
N.extension = {
	...
	name: "batch"
}, N._availableBatchers = /* @__PURE__ */ Object.create(null);
var P = N;
e.handleByMap(b.Batcher, P._availableBatchers), e.add(de);
//#endregion
//#region node_modules/pixi.js/lib/rendering/mask/alpha/AlphaMaskPipe.mjs
var Ce = new u(), we = class extends re {
	constructor() {
		super(), this.filters = [new Se({
			sprite: new ce(v.EMPTY),
			inverse: !1,
			resolution: "inherit",
			antialias: "inherit"
		})];
	...
	execute(e) {
		...
		if (e.action === "pushMaskBegin") {
			...
			if (r.inverse = e.inverse, r.channel = e.mask.channel, n) {
				...
				let n = oe(e.mask.mask, !0, Ce);
				e.mask.mask.measurable = !1, n.ceil();
				let i = t.renderTarget.renderTarget.colorTexture.source, a = w.getOptimalTexture(n.width, n.height, i._resolution, i.antialias);
			...
			n && w.returnTexture(e.filterTexture), f.return(e.filterEffect);
		}
	}
	destroy() {
...
var Ee = class {
	...
	execute(e) {
		...
		e.action === "pushMaskBegin" ? (r.renderTarget.ensureDepthStencil(), r.stencil.setStencilMode(T.RENDERING_MASK_ADD, a), a++, r.colorMask.setMask(0)) : e.action === "pushMaskEnd" ? (e.inverse ? r.stencil.setStencilMode(T.INVERSE_MASK_ACTIVE, a) : r.stencil.setStencilMode(T.MASK_ACTIVE, a), r.colorMask.setMask(15)) : e.action === "popMaskBegin" ? (r.colorMask.setMask(0), a === 0 ? (r.renderTarget.clear(null, O.STENCIL), r.stencil.setStencilMode(T.DISABLED, a)) : r.stencil.setStencilMode(T.RENDERING_MASK_REMOVE, a), a--) : e.action === "popMaskEnd" && (e.inverse ? r.stencil.setStencilMode(T.INVERSE_MASK_ACTIVE, a) : r.stencil.setStencilMode(T.MASK_ACTIVE, a), r.colorMask.setMask(15)), this._maskStackHash[i] = a;
	}
	destroy() {
...
var R = class {
	...
	_addRenderableCacheAsTexture(e, t) {
		let n = e._batchableRenderGroup ??= f.get(M);
...
var V = class {
	...
	setBlendMode(e, t, n) {
		let r = e instanceof ae;
		if (this._activeBlendMode === t) {
			this._isAdvanced && e && !r && this._renderableList?.push(e);
			return;
		}
		this._isAdvanced && this._endAdvancedBlendMode(n), this._activeBlendMode = t, e && (this._isAdvanced = !!B[t], this._isAdvanced && this._beginAdvancedBlendMode(e, n));
	}
	_beginAdvancedBlendMode(e, t) {
		...
		let r = this._ensureFilterEffect(n), i = e instanceof ae, a = {
			renderPipeId: "filter",
			action: "pushFilter",
			filterEffect: r,
	...
	_ensureFilterEffect(e) {
		...
		return t || (t = this._filterHash[e] = new re(), t.filters = [new B[e]()]), t;
	}
...
function ke(e, t = !1) {
	...
	for (let t in n) {
		...
		for (let t = 0; t < s; t++) {
			let n = o[t];
			n.parentRenderGroup === e && n.relativeRenderGroupDepth === i && je(n, r, 0);
		}
		H(o, s), a.index = 0;
	}
	if (t) for (let n = 0; n < e.renderGroupChildren.length; n++) ke(e.renderGroupChildren[n], t);
}
function Ae(e) {
	let t = e.root, n;
...
function je(e, t, n) {
	...
	let i = e.parent;
	if (i && !i.renderGroup ? (n |= e._updateFlags, e.relativeGroupTransform.appendFrom(r, i.relativeGroupTransform), n & Oe && Me(e, i, n)) : (n = e._updateFlags, e.relativeGroupTransform.copyFrom(r), n & Oe && Me(e, De, n)), !e.renderGroup) {
		let r = e.children, i = r.length;
		for (let e = 0; e < i; e++) je(r[e], t, n);
...
var Pe = new i(), Fe = class {
	...
	render({ container: e, transform: t }) {
		...
		}), L(e.renderGroup, o), o.uniformBatch && o.uniformBatch.renderEnd(), t && e.renderGroup.localTransform.copyFrom(a), e.parent = n, e.renderGroup.renderGroupParent = r;
	}
	destroy() {
		this._renderer = null;
	}
	_updateCachedRenderGroups(e, t) {
		...
		if (e.invalidateMatrices(), e.isCachedAsTexture) {
			if (e.textureNeedsUpdate) {
				...
				let c = w.getOptimalTexture(t.width, t.height, r, i);
	...
	_updateRenderGroups(e) {
		...
		if (e.runOnRender(t), e.instructionSet.renderPipes = n, e.structureDidChange ? H(e.childrenRenderablesToUpdate.list, 0) : Ne(e, n), ke(e), e.structureDidChange ? (e.structureDidChange = !1, this._buildInstructions(e, t)) : this._updateRenderables(e), e.childrenRenderablesToUpdate.index = 0, t.renderPipes.batch.upload(e.instructionSet), !(e.isCachedAsTexture && !e.textureNeedsUpdate)) for (let t = 0; t < e.renderGroupChildren.length; t++) this._updateRenderGroups(e.renderGroupChildren[t]);
	}
...
var Le = G, Re = class e extends v {
	...
	generateTexture(e) {
		...
		a = a ? Array.isArray(a) && a.length === 4 ? a : y.shared.setValue(a).toArray() : Ve;
		let o = e.frame?.copyTo(ze) || ie(r, Be).rectangle, s = e.defaultAnchor && { defaultAnchor: e.defaultAnchor };
...
var Ge = K, Ke = class {
	...
	bind({ size: e, projectionMatrix: n, worldTransformMatrix: r, worldColor: a, offset: o }) {
		...
		let d = u.uniforms;
		d.uProjectionMatrix = l.projectionMatrix, d.uResolution = l.resolution, d.uWorldTransformMatrix.copyFrom(l.worldTransformMatrix), d.uWorldTransformMatrix.tx -= l.offset.x, d.uWorldTransformMatrix.ty -= l.offset.y, j(l.worldColor, d.uWorldColorAlpha, 0), u.update();
		let f;
...
var qe = 1, Je = class {
	...
	init() {
		C.system.add(this._update, this);
	}
	repeat(e, t, n = !0) {
		let r = qe++, i = 0;
	...
	destroy() {
		C.system.remove(this._update, this), this._tasks.length = 0;
	}
};
Je.extension = {
	type: [
...
function Xe(e) {
	if (!Ye) {
		if (g.get().getNavigator().userAgent.toLowerCase().indexOf("chrome") > -1) {
			let t = [
				`%c  %c  %c  %c  %c PixiJS %c v${k} (${e}) http://www.pixijs.com/
...
`,
		...
		} else globalThis.console && globalThis.console.log(`PixiJS ${k} - ${e} - http://www.pixijs.com/`);
		Ye = !0;
	}
}
//#endregion
...
var q = class {
	...
	init(e) {
		if (e.hello) {
			...
			this._renderer.type === l.WEBGL && (e += ` ${this._renderer.context.webGLVersion}`), Xe(e);
		}
	}
};
q.extension = {
...
var $ = class e {
	...
	init(t) {
		t = {
			...e.defaultOptions,
			...t
		}, t.view && (r(m, "ViewSystem.view has been renamed to ViewSystem.canvas"), t.canvas = t.view), this.screen = new n(0, 0, t.width, t.height), this.canvas = t.canvas || g.get().createCanvas(), this.antialias = !!t.antialias, this.texture = Q(this.canvas, t), this.renderTarget = new X({
...
var it = class {
	constructor(e) {
		this.rootViewPort = new n(), this.viewport = new n(), this.mipLevel = 0, this.layer = 0, this.onRenderTargetChange = new me("onRenderTargetChange"), this.projectionMatrix = new i(), this.defaultClearColor = [
			0,
			0,
			0,
			0
	...
	_initRenderTarget(e) {
		let t = null;
		return x.test(e) && (e = Q(e).source), e instanceof X ? t = e : e instanceof _ && (t = new X({ colorTextures: [e] }), e.source instanceof x && (t.isRoot = !0), e.once("destroy", () => {
...
//#endregion
export { z as a, F as c, ve as d, _e as f, V as i, P as l, pe as m, tt as n, R as o, O as p, et as r, I as s, it as t, j as u };
