import { B as e, C as t, M as n, P as r, a as i, b as a, c as o, o as s, p as c, s as l, t as u, u as d, v as f, w as p, x as m, z as h } from "./Geometry-uzK7Lbb5.js";
import { a as g, c as _, d as ee, g as v, h as te, m as ne, o as y, r as b, t as re, u as x } from "./Filter-BHocqa2Q.js";
import { r as ie, t as ae } from "./canvasUtils-DAQWjL3Q.js";
import { n as S, t as C } from "./Cache-CEQe56KT.js";
import { t as oe } from "./CanvasPool-L6W9YqAe.js";
//#region node_modules/pixi.js/lib/rendering/mask/utils/addMaskBounds.mjs
var se = new a();
function w(e, t, n) {
	let r = se;
	e.measurable = !0, ne(e, n, r), t.addBoundsMask(r), e.measurable = !1;
}
//#endregion
...
function T(e, t, n) {
	...
	ee(e, r, E(e, n, i)), e.measurable = !1, t.addBoundsMask(r), v.return(i), te.return(r);
}
function E(e, t, n) {
	return e ? (e !== t && (E(e.parent, t, n), e.updateLocalTransform(), n.append(e.localTransform)), n) : (f("Mask bounds, renderable is not inside the root container"), n);
}
//#endregion
...
var D = class {
	...
	init(e) {
		this.mask = e, this.renderMaskToTexture = !(e instanceof y), this.mask.renderable = this.renderMaskToTexture, this.mask.includeInBuild = !this.renderMaskToTexture, this.mask.measurable = !1;
	}
	reset() {
		this.mask !== null && (this.mask.measurable = !0, this.mask = null);
	}
	addBounds(e, t) {
		this.inverse || w(this.mask, e, t);
	}
	addLocalBounds(e, t) {
		T(this.mask, e, t);
	}
...
var M = class e extends p {
	...
	updateFrame() {
		if (!this.destroyed) {
			if (this._updateFPS) {
				let e = b.shared.elapsedMS * this.resource.playbackRate;
	...
	_configureAutoUpdate() {
		this._autoUpdate && this._isSourcePlaying() ? !this._updateFPS && this.resource.requestVideoFrameCallback ? (this._isConnectedToTicker && (b.shared.remove(this.updateFrame, this), this._isConnectedToTicker = !1, this._msToNextUpdate = 0), this._videoFrameRequestCallbackHandle === null && (this._videoFrameRequestCallbackHandle = this.resource.requestVideoFrameCallback(this._videoFrameRequestCallback))) : (this._videoFrameRequestCallbackHandle !== null && (this.resource.cancelVideoFrameCallback(this._videoFrameRequestCallbackHandle), this._videoFrameRequestCallbackHandle = null), this._isConnectedToTicker || (b.shared.add(this.updateFrame, this), this._isConnectedToTicker = !0, this._msToNextUpdate = 0)) : (this._videoFrameRequestCallbackHandle !== null && (this.resource.cancelVideoFrameCallback(this._videoFrameRequestCallbackHandle), this._videoFrameRequestCallbackHandle = null), this._isConnectedToTicker && (b.shared.remove(this.updateFrame, this), this._isConnectedToTicker = !1, this._msToNextUpdate = 0));
	}
	static test(e) {
		return globalThis.HTMLVideoElement && e instanceof HTMLVideoElement;
	}
};
M.extension = h.TextureSource, M.defaultOptions = {
	...p.defaultOptions,
	autoLoad: !0,
	autoPlay: !0,
	updateFPS: 0,
...
var N = M, P = [];
e.handleByList(h.TextureSource, P);
function F(e = {}) {
...
function ce(e = {}, t = !1) {
	...
	if (!t && C.has(r)) return C.get(r);
	let a = new m({ source: F(i) });
	return a.on("destroy", () => {
		C.has(r) && C.remove(r);
	}), t || C.set(r, a), a;
}
function le(e, t = !1) {
	return typeof e == "string" ? C.get(e) : e instanceof p ? new m({ source: e }) : ce(e, t);
}
//#endregion
//#region node_modules/pixi.js/lib/rendering/init.mjs
m.from = le, p.from = F, e.add(D, O, k, N, ie, g, t);
//#endregion
...
function de(e, t, n) {
	return e.replace(new RegExp(ue(t), "g"), n);
}
function fe(e, t) {
...
var z = {
	...
	toAbsolute(e, t, n) {
		...
		let r = R(this.toPosix(t ?? c.get().getBaseUrl())), i = R(this.toPosix(n ?? this.rootname(r)));
		return e = this.toPosix(e), e.startsWith("/") ? z.join(i, e.slice(1)) : this.isAbsolute(e) ? e : this.join(r, e);
	},
	normalize(e) {
		...
		let r = e.endsWith("/");
		return e = fe(e, !1), e.length > 0 && r && (e += "/"), n ? `/${e}` : t + e;
	},
	isAbsolute(e) {
	...
	join(...e) {
		...
		for (let n = 0; n < e.length; ++n) {
			let r = e[n];
			if (L(r), r.length > 0) if (t === void 0) t = r;
			else {
				let i = e[n - 1] ?? "";
...
function B(e, t, n, r, i) {
	...
	for (let o = 0; o < a.length; o++) {
		let s = a[o];
		n < t.length - 1 ? B(e.replace(r[n], s), t, n + 1, r, i) : i.push(e.replace(r[n], s));
	}
}
function pe(e) {
	let t = e.match(/\{(.*?)\}/g), n = [];
...
var V = (e) => !Array.isArray(e), H = class {
	constructor() {
	...
	getAlias(e) {
		let { alias: t, src: n } = e;
		return S(t || n, (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map((e) => e?.src ?? e) : e?.src ? e.src : e, !0);
	}
	removeAlias(e, t) {
		this._assetMap[e] && (t && t !== this._resolverHash[e] || (delete this._resolverHash[e], delete this._assetMap[e]));
	}
	addManifest(e) {
		this._manifest && f("[Resolver] Manifest already exists, this will be overwritten"), this._manifest = e, e.bundles.forEach((e) => {
	...
	add(e) {
		...
		let n = (e) => {
			this.hasKey(e) && f(`[Resolver] already has key: ${e} overwriting`);
		};
		S(t).forEach((e) => {
			let { src: t } = e, { data: r, format: i, loadParser: a, parser: o } = e, s = S(t).map((e) => typeof e == "string" ? pe(e) : Array.isArray(e) ? e : [e]), c = this.getAlias(e);
	...
	_buildResolvedAsset(e, t) {
		...
		return (this._basePath || this._rootPath) && (e.src = z.toAbsolute(e.src, this._basePath, this._rootPath)), e.alias = n ?? e.alias ?? [e.src], e.src = this._appendDefaultSearchParams(e.src), e.data = {
			...r || {},
			...e.data
		}, e.loadParser = i ?? e.loadParser, e.parser = a ?? e.parser, e.format = o ?? e.format ?? me(e.src), s !== void 0 && (e.progressSize = s), e;
	}
};
...
var U = (e, t) => {
	...
	constructor(e, t) {
		...
		this.cachePrefix = a, this._texture = r instanceof m ? r : null, this.textureSource = r.source, this.textures = {}, this.animations = {}, this.data = i;
	...
	_processFrames(t, r = !1) {
		...
		for (; i - t < a && i < this._frameKeys.length;) {
			...
			if (r) {
				let i = null, a = null, o = t.trimmed !== !1 && t.sourceSize ? t.sourceSize : t.frame, s = new n(0, 0, Math.floor(o.w) / this.resolution, Math.floor(o.h) / this.resolution);
				i = t.rotated ? new n(Math.floor(r.x) / this.resolution, Math.floor(r.y) / this.resolution, Math.floor(r.h) / this.resolution, Math.floor(r.w) / this.resolution) : new n(Math.floor(r.x) / this.resolution, Math.floor(r.y) / this.resolution, Math.floor(r.w) / this.resolution, Math.floor(r.h) / this.resolution), t.trimmed !== !1 && t.spriteSourceSize && (a = new n(Math.floor(t.spriteSourceSize.x) / this.resolution, Math.floor(t.spriteSourceSize.y) / this.resolution, Math.floor(r.w) / this.resolution, Math.floor(r.h) / this.resolution)), this.textures[e] = new m({
...
function K(e, t, n) {
	...
	if (e.forEach((e) => {
		...
		t.linkedSheets.forEach((e, i) => {
			let a = K([`${n}/${t.data.meta.related_multi_packs[i]}`], e, !0);
			Object.assign(r, a);
		});
	}
	return r;
...
var ge = {
	extension: h.Asset,
	cache: {
		test: (e) => e instanceof G,
		getCacheableAssets: (e, t) => K(e, t, !1)
	},
	resolver: {
		extension: {
	...
	loader: {
		...
		async testParse(e, t) {
			return z.extname(t.src).toLowerCase() === ".json" && !!e.frames;
		},
		async parse(e, t, n) {
			let { texture: r, imageFilename: i, textureOptions: a, cachePrefix: o } = t?.data ?? {}, s = z.dirname(t.src);
			s && s.lastIndexOf("/") !== s.length - 1 && (s += "/");
			let c;
			if (r instanceof m) c = r;
			else {
				let r = U(s + (i ?? e.meta.image), t.src);
				c = (await n.load([{
					src: r,
					data: a
				}]))[r];
			...
			if (Array.isArray(u)) {
				...
				for (let r of u) {
					...
					let i = s + r;
					t.data?.ignoreMultiPack || (i = U(i, t.src), e.push(n.load({
						src: i,
						data: {
							textureOptions: a,
							ignoreMultiPack: !0
...
function be(e, t, n, r, i = !1) {
	...
	let o = x.getOptimalTexture(a.width, a.height, r, !1, i);
...
var xe = class {
	constructor() {
		this.skip = !1, this.useClip = !1, this.filters = null, this.container = null, this.bounds = new a(), this.cssFilterString = "";
	}
}, Z = class {
	constructor(e) {
	...
	generateFilteredTexture({ texture: e, filters: t }) {
		...
		let r = ae.getCanvasSource(e);
		if (!r) return e;
		let i = e.frame, a = e.source._resolution ?? e.source.resolution ?? 1, o = i.width, s = i.height, { canvas: c, context: l } = oe.getOptimalCanvasAndContext(o, s, a);
		l.setTransform(1, 0, 0, 1, 0, 0), l.clearRect(0, 0, c.width, c.height), n.length && (l.filter = n.join(" "));
		let u = i.x * a, d = i.y * a, f = o * a, p = s * a;
		return l.drawImage(r, u, d, f, p, 0, 0, f, p), l.filter = "none", l.globalAlpha = 1, be(c, o, s, a);
	}
	...
	_pushFilterFrame() {
		...
		return e ||= this._filterStack[this._filterStackIndex] = new xe(), this._filterStackIndex++, e;
	}
	_popFilterFrame() {
...
var Ce = new u({
	...
	constructor() {
		this.skip = !1, this.inputTexture = null, this.backTexture = null, this.filters = null, this.bounds = new a(), this.container = null, this.blendRequired = !1, this.outputRenderSurface = null, this.globalFrame = {
			x: 0,
			y: 0,
			width: 0,
			height: 0
	...
	generateFilteredTexture({ texture: e, filters: t }) {
		...
		let s = i;
		this._calculateGlobalFrame(n, 0, 0, s, r.width, r.height), n.outputRenderSurface = x.getOptimalTexture(o.width, o.height, n.resolution, n.antialias), n.backTexture = m.EMPTY, n.inputTexture = e, this.renderer.renderTarget.finishRenderPass(), this._applyFiltersToTexture(n, !0);
		let c = n.outputRenderSurface;
		return c.source.alphaMode = "premultiplied-alpha", c;
	}
	pop() {
		let e = this.renderer, t = this._popFilterData();
		t.skip || (e.globalUniforms.pop(), e.renderTarget.finishRenderPass(), this._activeFilterData = t, this._applyFiltersToTexture(t, !1), t.blendRequired && x.returnTexture(t.backTexture), x.returnTexture(t.inputTexture));
	}
	getBackTexture(e, t, n) {
		let r = e.colorTexture.source._resolution, i = x.getOptimalTexture(t.width, t.height, r, !1), a = t.minX, o = t.minY;
	...
	calculateSpriteMatrix(e, t) {
		let n = this._activeFilterData, i = e.set(n.inputTexture._source.width, 0, 0, n.inputTexture._source.height, n.bounds.minX, n.bounds.minY), a = t.worldTransform.copyTo(r.shared), o = t.renderGroup || t.parentRenderGroup;
		return o && o.cacheToLocalTransform && a.prepend(o.cacheToLocalTransform), a.invert(), i.prepend(a), i.scale(1 / t.texture.orig.width, 1 / t.texture.orig.height), i.translate(t.anchor.x, t.anchor.y), i;
	}
	destroy() {
	...
	_setupBindGroupsAndRender(e, t, n) {
		...
		}), n.type === i.WEBGL && n.renderTarget.finishRenderPass();
	}
	_setupFilterTextures(e, t, n, r) {
		if (e.backTexture = m.EMPTY, e.inputTexture = x.getOptimalTexture(t.width, t.height, e.resolution, e.antialias), e.blendRequired) {
	...
	_updateFilterUniforms(e, t, n, r, i, a, o, s) {
		let c = this._filterGlobalUniforms.uniforms, l = c.uOutputFrame, u = c.uInputSize, d = c.uInputPixel, f = c.uInputClamp, p = c.uGlobalFrame, h = c.uOutputTexture;
		...
		p[0] = r * a, p[1] = i * a, p[2] = g.source.width * a, p[3] = g.source.height * a, t instanceof m && (t.source.resource = null);
		let _ = this.renderer.renderTarget.getRenderTarget(t);
		this.renderer.renderTarget.bind(t, !!s), t instanceof m ? (h[0] = t.frame.width, h[1] = t.frame.height) : (h[0] = _.width, h[1] = _.height), h[2] = _.isRoot ? -1 : 1, this._filterGlobalUniforms.update();
	}
	...
	_applyFiltersToTexture(e, t) {
		...
		if (this._globalFilterBindGroup.setResource(n.source.style, 2), this._globalFilterBindGroup.setResource(e.backTexture.source, 3), a === o) i[a].apply(this, n, e.outputRenderSurface, t);
			...
			let n = e.inputTexture, s = x.getOptimalTexture(r.width, r.height, n.source._resolution, !1), c = s;
			for (let e = a; e < o; e++) {
				let t = i[e];
			...
			i[o].apply(this, n, e.outputRenderSurface, t), x.returnTexture(s);
		}
	}
	_calculateFilterBounds(e, t, n, r, i) {
		let a = this.renderer, o = e.bounds, s = e.filters, c = Infinity, l = 0, u = !0, d = !1, p = !1, m = !0, h = -1, g = -1;
		for (let e = 0; e < s.length; e++) {
			let t = s[e];
			if (t.enabled) {
				if (h === -1 && (h = e), g = e, c = Math.min(c, t.resolution === "inherit" ? r : t.resolution), l += t.padding, t.antialias === "off" ? u = !1 : t.antialias === "inherit" && (u &&= n), t.clipToViewport || (m = !1), !(t.compatibleRenderers & a.type)) {
					p = !1;
					break;
				}
				if (t.blendRequired && !(a.backBuffer?.useBackBuffer ?? !0)) {
					f("Blend filter requires backBuffer on WebGL renderer to be enabled. Set `useBackBuffer: true` in the renderer options."), p = !1;
					break;
				}
				p = !0, d ||= t.blendRequired;
			}
		}
		if (!p) {
			e.skip = !0;
		...
		if (m && o.fitBounds(0, t.width / r, 0, t.height / r), o.scale(c).ceil().scale(1 / c).pad((l | 0) * i), !o.isPositive) {
			e.skip = !0;
			return;
		}
		e.antialias = u, e.resolution = c, e.blendRequired = d, e.firstEnabledIndex = h, e.lastEnabledIndex = g;
	}
	_popFilterData() {
...
//#endregion
export { H as a, I as c, U as i, N as l, Q as n, V as o, Z as r, z as s, $ as t, j as u };
