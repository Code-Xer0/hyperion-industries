import { B as e, D as t, F as n, I as r, L as i, O as a, P as o, R as s, T as c, _ as l, b as u, c as d, g as f, h as ee, i as te, j as ne, k as p, m as re, p as ie, u as ae, v as m, w as h, x as g, y as oe, z as _ } from "./Geometry-uzK7Lbb5.js";
...
e.handleByList(_.MaskEffect, x._effectClasses);
//#endregion
...
var fe = {
...
}, S = f.getPool(o), C = f.getPool(u), me = new o(), he = {
	...
	_getGlobalBoundsRecursive(e, t, n) {
		...
		if (i) {
			...
			e && r.applyMatrix(n.worldTransform.copyTo(me).invert()), t.addBounds(r), C.return(r);
...
function w(e, t, n) {
	n.clear();
	let r, i;
	return e.parent ? t ? r = e.parent.worldTransform : (i = S.get().identity(), r = E(e, i)) : r = o.IDENTITY, T(e, n, r, t), i && S.return(i), n.isValid || n.set(0, 0, 0, 0), n;
}
function T(e, t, n, r) {
	...
	if (s && (t = C.get().clear()), e.boundsArea) t.addRect(e.boundsArea, i);
	else {
		let n = e.bounds;
	...
	if (s) {
		...
		a.addBounds(t, o.IDENTITY), C.return(t);
	}
	r || S.return(i);
}
function E(e, t) {
...
function A(e, t, n) {
	return t.clear(), n ||= o.IDENTITY, j(e, t, n, e, !0), t.isValid || t.set(0, 0, 0, 0), t;
}
function j(e, t, n, r, i) {
	...
	if (c && (t = C.get().clear()), e.boundsArea) t.addRect(e.boundsArea, a);
	else {
	...
	if (c) {
		...
		s.addBounds(t, o.IDENTITY), C.return(t);
	}
	S.return(a);
}
//#endregion
...
var _e = new o(), ve = {
	...
	getLocalBounds() {
		...
		return e.index = 1, e.didChange = !1, e.data[0] !== this._didViewChangeTick && (e.didChange = !0, e.data[0] = this._didViewChangeTick), M(this, e), e.didChange && A(this, e.localBounds, _e), e.localBounds;
	},
	getBounds(e, t) {
		return w(this, e, t || new u());
	}
}, ye = {
	_onRender: null,
	set onRender(e) {
	...
	sortChildren() {
		this.sortDirty && (this.sortDirty = !1, this.children.sort(xe));
	}
};
function xe(e, t) {
...
var F = new v(null), I = new v(null), L = new v(null, 1, 1), R = new v(null), z = class t extends s {
	constructor(e = {}) {
		super(), this.uid = ne("renderable"), this._updateFlags = 15, this.renderGroup = null, this.parentRenderGroup = null, this.parentRenderGroupIndex = 0, this.didChange = !1, this.didViewUpdate = !1, this.relativeRenderGroupDepth = 0, this.children = [], this.parent = null, this.includeInBuild = !0, this.measurable = !0, this.isSimple = !0, this.parentRenderLayer = null, this.updateTick = -1, this.localTransform = new o(), this.relativeGroupTransform = new o(), this.groupTransform = this.relativeGroupTransform, this.destroyed = !1, this._position = new v(this, 0, 0), this._scale = L, this._pivot = I, this._origin = R, this._skew = F, this._cx = 1, this._sx = 0, this._cy = 0, this._sy = 1, this._rotation = 0, this.localColor = 16777215, this.localAlpha = 1, this.groupAlpha = 1, this.groupColor = 16777215, this.groupColorAlpha = 4294967295, this.localBlendMode = "inherit", this.groupBlendMode = "normal", this.localDisplayStatus = 7, this.globalDisplayStatus = 7, this._didContainerChangeTick = 0, this._didViewChangeTick = 0, this._didLocalTransformChangeId = -1, this.effects = [], we(this, e, {
			children: !0,
			parent: !0,
			effects: !0
	...
	enableRenderGroup() {
		...
		e?.removeChild(this), this.renderGroup = f.get(P, this), this.groupTransform = o.IDENTITY, e?.addChild(this), this._updateIsSimple();
	}
	disableRenderGroup() {
		if (!this.renderGroup) return;
		let e = this.parentRenderGroup;
	...
	set pivot(e) {
		this._pivot === I && (this._pivot = new v(this, 0, 0), this._origin !== R && m("Setting both a pivot and origin on a Container is not recommended. This can lead to unexpected behavior if not handled carefully.")), typeof e == "number" ? this._pivot.set(e) : this._pivot.copyFrom(e);
	}
	get skew() {
	...
	set origin(e) {
		this._origin === R && (this._origin = new v(this, 0, 0), this._pivot !== I && m("Setting both a pivot and origin on a Container is not recommended. This can lead to unexpected behavior if not handled carefully.")), typeof e == "number" ? this._origin.set(e) : this._origin.copyFrom(e);
	}
	get width() {
	...
	set tint(e) {
		let t = oe.shared.setValue(e ?? 16777215).toBgrNumber();
...
e.mixin(z, ue, he, Se, ye, ve, fe, pe, be, ce, le, ge, de);
//#endregion
...
var B = class extends z {
	...
	constructor(e = g.EMPTY) {
		e instanceof g && (e = { texture: e });
		let { texture: t = g.EMPTY, anchor: n, roundPixels: r, width: i, height: a, ...o } = e;
		super({
			label: "Sprite",
			...o
	...
	static from(t, n = !1) {
		return t instanceof g ? new e(t) : new e(g.from(t, n));
	}
	set texture(e) {
		e ||= g.EMPTY;
		let t = this._texture;
	...
	get visualBounds() {
		return se(this._visualBounds, this._anchor, this._texture), this._visualBounds;
	}
	get sourceBounds() {
...
V.extension = _.TextureSource;
//#endregion
//#region node_modules/pixi.js/lib/ticker/const.mjs
var H = /* @__PURE__ */ ((e) => (e[e.INTERACTION = 50] = "INTERACTION", e[e.HIGH = 25] = "HIGH", e[e.NORMAL = 0] = "NORMAL", e[e.LOW = -25] = "LOW", e[e.UTILITY = -50] = "UTILITY", e))(H || {}), U = class {
	...
	constructor() {
		this.autoStart = !1, this.deltaTime = 1, this.lastTime = -1, this.speed = 1, this.started = !1, this._requestId = null, this._maxElapsedMS = 100, this._minElapsedMS = 0, this._protected = !1, this._lastFrame = -1, this._head = new U(null, null, Infinity), this.deltaMS = 1 / e.targetFPMS, this.elapsedMS = 1 / e.targetFPMS, this._tick = (e) => {
	...
	add(e, t, n = H.NORMAL) {
		return this._addListener(new U(e, t, n));
	}
	addOnce(e, t, n = H.NORMAL) {
		return this._addListener(new U(e, t, n, !0));
	}
	_addListener(e) {
...
var Q = Z, $ = class e extends te {
	...
	static from(t) {
		...
		return n && (a = d.from(n)), r && (o = ae.from(r)), new e({
			gpuProgram: a,
			glProgram: o,
			...i
		});
...
var Oe = $;
//#endregion
export { b as _, V as a, z as c, A as d, k as f, S as g, C as h, H as i, P as l, w as m, Q as n, Te as o, O as p, Ee as r, B as s, Oe as t, N as u, y as v };
