import { A as e, B as t, E as n, F as r, M as i, O as a, P as o, R as s, b as c, g as l, h as u, j as d, k as f, m as p, p as m, v as h, x as g, y as _, z as v } from "./Geometry-uzK7Lbb5.js";
import { r as y } from "./canvasUtils-DAQWjL3Q.js";
import { h as b, n as x, t as S } from "./GCManagedHash-im6pMy80.js";
import { t as C } from "./getTextureBatchBindGroup-Cc95ygL_.js";
...
function D(e) {
	let t = [];
	return e.replace(T, (e, n, r) => {
		let i = n.toLowerCase(), a = n, o = O(r);
...
var N, P, F = class e {
	...
	containsPolygon(e) {
		let t = this.getBounds(N), n = e.getBounds(P);
	...
	strokeContains(e, t, n, r = .5) {
		...
		for (let n = 0; n < c; n += 2) {
			...
			if (M(e, t, r, i, c, l) <= (Math.sign((c - r) * (t - i) - (l - i) * (e - r)) < 0 ? o : a)) return !0;
		}
		return !1;
	}
	getBounds(e) {
	...
	strokeContains(e, t, n, r = .5) {
		...
		return (e >= i - l && e <= i + u || e >= h - u && e <= h + l) && t >= f && t <= f + m || (t >= a - l && t <= a + u || t >= g - u && t <= g + l) && e >= d && e <= d + p ? !0 : e < d && t < f && I(e, t, d, f, c, u, l) || e > h - c && t < f && I(e, t, h - c, f, c, u, l) || e > h - c && t > g - c && I(e, t, h - c, g - c, c, u, l) || e < d && t > g - c && I(e, t, d, g - c, c, u, l);
	}
	toString() {
...
function L(e, t, n, r, i, a, o, s = null) {
	let c = 0;
	n *= t, i *= a;
...
var re = new o(), ie = class {
	...
	get transform() {
		return this.renderable?.groupTransform || re;
	}
	copyTo(e) {
...
function de(e, t, n, i, a, o) {
	...
	f || (c.cap === "round" ? g += z(x - D * (N - P) * .5, S - O * (N - P) * .5, x - D * N, S - O * N, x + D * P, S + O * P, m, !0) + 2 : c.cap === "square" && (g += ue(x, S, D, O, N, P, !0, m))), m.push(x - D * N, S - O * N), m.push(x + D * P, S + O * P);
	for (let t = 1; t < h - 1; ++t) {
		...
		if (Math.abs(s) < .001 * Math.abs(o)) {
			m.push(C - D * N, w - O * N), m.push(C + D * P, w + O * P), o >= 0 && (c.join === "round" ? g += z(C, w, C - D * N, w - O * N, C - k * N, w - A * N, m, !1) + 4 : g += 2, m.push(C - k * P, w - A * P), m.push(C + k * N, w + A * N));
			continue;
		}
...
var me = [], he = {
	...
	buildLinearGradient() {
		...
		let c = this.colorStops.length ? this.colorStops : ve, l = this._textureSize, { canvas: u, context: d } = be(l, 1), f = s ? d.createLinearGradient(this._textureSize, 0, 0, 0) : d.createLinearGradient(0, 0, this._textureSize, 0);
		ye(f, c), d.fillStyle = f, d.fillRect(0, 0, l, 1), this.texture = new g({ source: new y({
			resource: u,
	...
	buildRadialGradient() {
		if (this.texture) return;
		let e = this.colorStops.length ? this.colorStops : ve, t = this._textureSize, { canvas: n, context: r } = be(t, t), { x: i, y: a } = this.center, { x: s, y: c } = this.outerCenter, l = this.innerRadius, u = this.outerRadius, d = s - u, f = c - u, p = t / (u * 2), m = (i - d) * p, h = (a - f) * p, _ = r.createRadialGradient(m, h, l * p, (s - d) * p, (c - f) * p, u * p);
		ye(_, e), r.fillStyle = e[e.length - 1].color, r.fillRect(0, 0, t, t), r.fillStyle = _, r.translate(m, h), r.rotate(this.rotation), r.scale(1, this.scale), r.translate(-m, -h), r.fillRect(0, 0, t, t), this.texture = new g({ source: new y({
			resource: n,
			addressMode: this._wrapMode
		}) });
		let v = new o();
...
function we(e, t, n, r) {
	...
	return !(t.fill instanceof V) && a.addressMode === "clamp-to-edge" && (a.addressMode = "repeat", a.update()), r && i.append(Se.copyFrom(r).invert()), i;
}
//#endregion
//#region node_modules/pixi.js/lib/scene/graphics/shared/utils/buildContextBatches.mjs
var H = {};
t.handleByMap(v.ShapeBuilder, H), t.add(ge, he, _e, R, ae, oe);
var Te = new i(), Ee = new o();
function De(e, t) {
	...
	for (let t = 0; t < e.instructions.length; t++) {
		...
		if (i.action === "texture") Oe(i.data, r, n);
		else if (i.action === "fill" || i.action === "stroke") {
			let e = i.action === "stroke", t = i.data.path.shapePath, a = i.data.style, o = i.data.hole;
			e && o && ke(o.shapePath, a, !0, r, n), o && (t.shapePrimitives[t.shapePrimitives.length - 1].holes = o.shapePath.shapePrimitives), ke(t, a, e, r, n);
		}
	}
}
function Oe(e, t, n) {
	let r = [], i = H.rectangle, a = Te;
	...
	o && ne(r, o), i.triangulate(r, s, 2, f, u, d);
...
function ke(e, t, n, r, i) {
	...
	e.shapePrimitives.forEach(({ shape: e, transform: c, holes: u }) => {
		...
		if (c && ne(d, c), n) {
			...
			r.pixelLine ? (fe(d, n, a, s), h = "line-list") : de(d, r, !1, n, a, s);
		} else if (u) {
			let e = [], t = d.slice();
			Ae(u).forEach((n) => {
		...
		if (v !== g.WHITE) {
			let n = we(Ee, t, e, c);
			L(a, 2, m, o, _, 2, a.length / 2 - m, n);
		} else te(o, _, 2, a.length / 2 - m);
		let y = l.get(ie);
...
var je = class {
	...
	_initContextRenderData(e) {
		let t = l.get(Me, { maxTextures: this._renderer.limits.maxBatchableTextures }), n = e._gpuData[this._renderer.uid], { batches: r, geometryData: i } = n;
		n.graphicsData = t;
...
U.extension = {
	...
	name: "graphicsContext"
}, U.defaultOptions = { bezierSmoothness: .5 };
var W = U, Ne = 8, G = 1.1920929e-7, Pe = 1;
function Fe(e, t, n, r, i, a, o, s, c, l) {
	let u = (Pe - Math.min(.99, Math.max(0, l ?? W.defaultOptions.bezierSmoothness))) / 1;
	return u *= u, Ie(t, n, r, i, a, o, s, c, e, u), e;
}
function Ie(e, t, n, r, i, a, o, s, c, l) {
	K(e, t, n, r, i, a, o, s, c, l, 0), c.push(o, s);
}
function K(e, t, n, r, i, a, o, s, c, l, u) {
	...
	K(e, t, d, f, _, v, x, S, c, l, u + 1), K(x, S, y, b, h, g, o, s, c, l, u + 1);
}
//#endregion
//#region node_modules/pixi.js/lib/scene/graphics/shared/buildCommands/buildAdaptiveQuadratic.mjs
var Le = 8, Re = 1.1920929e-7, ze = 1;
function Be(e, t, n, r, i, a, o, s) {
	let c = (ze - Math.min(.99, Math.max(0, s ?? W.defaultOptions.bezierSmoothness))) / 1;
	return c *= c, Ve(t, n, r, i, a, o, e, c), e;
}
function Ve(e, t, n, r, i, a, o, s) {
	q(o, e, t, n, r, i, a, s, 0), o.push(i, a);
}
function q(e, t, n, r, i, a, o, s, c) {
	...
	q(e, t, n, l, u, p, m, s, c + 1), q(e, p, m, d, f, a, o, s, c + 1);
}
//#endregion
...
}, Je = (e, t, n, r, i, a, o, s, c, l, u, d, f) => {
	let p = i ** 2, m = a ** 2, h = u ** 2, g = d ** 2, _ = p * m - p * g - m * h;
	_ < 0 && (_ = 0), _ /= p * g + m * h, _ = Math.sqrt(_) * (o === s ? -1 : 1);
	let v = _ * i / a * d, y = _ * -a / i * u, b = l * v - c * y + (e + n) / 2, x = c * v + l * y + (t + r) / 2, S = (u - v) / i, C = (d - y) / a, w = (-u - v) / i, T = (-d - y) / a, E = qe(1, 0, S, C), D = qe(S, C, w, T);
	s === 0 && D > 0 && (D -= J), s === 1 && D < 0 && (D += J), f.centerX = b, f.centerY = x, f.ang1 = E, f.ang2 = D;
};
function Ye(e, t, n, r, i, a, o, s = 0, c = 0, l = 0) {
	if (a === 0 || o === 0) return;
	...
	m > 1 && (a *= Math.sqrt(m), o *= Math.sqrt(m)), Je(t, n, r, i, a, o, c, l, u, d, f, p, We);
	let { ang1: h, ang2: g } = We, { centerX: _, centerY: v } = We, y = Math.abs(g) / (J / 4);
	...
	for (let t = 0; t < b; t++) {
		let t = Ke(h, g), { x: n, y: r } = Ge(t[0], a, o, d, u, _, v, C), { x: i, y: s } = Ge(t[1], a, o, d, u, _, v, C), { x: c, y: l } = Ge(t[2], a, o, d, u, _, v, C);
		Fe(e, x, S, n, r, i, s, c, l), x = c, S = l, h += g;
	}
}
//#endregion
...
var Qe = new i(), $e = class {
	...
	arc(e, t, n, r, i, a) {
		...
		return He(o, e, t, n, r, i, a), this;
	}
	arcTo(e, t, n, r, i) {
		this._ensurePoly();
		let a = this._currentPoly.points;
		return Ue(a, e, t, n, r, i), this;
	}
	arcToSvg(e, t, n, r, i, a, o) {
		let s = this._currentPoly.points;
		return Ye(s, this._currentPoly.lastX, this._currentPoly.lastY, a, o, e, t, n, r, i), this;
	}
	bezierCurveTo(e, t, n, r, i, a, o) {
		this._ensurePoly();
		let s = this._currentPoly;
		return Fe(this._currentPoly.points, s.lastX, s.lastY, e, t, n, r, i, a, o), this;
	}
	quadraticCurveTo(e, t, n, r, i) {
		this._ensurePoly();
		let a = this._currentPoly;
		return Be(this._currentPoly.points, a.lastX, a.lastY, e, t, n, r, i), this;
	}
	closePath() {
	...
	circle(e, t, n, r) {
		return this.drawShape(new A(e, t, n), r), this;
	}
	poly(e, t, n) {
		let r = new F(e);
	...
	roundShape(e, t, n = !1, r) {
		return e.length < 3 ? this : (n ? Ze(this, e, t, r) : Xe(this, e, t), this.closePath());
	}
	...
	ellipse(e, t, n, r, i) {
		return this.drawShape(new j(e, t, n, r), i), this;
	}
	roundRect(e, t, n, r, i, a) {
		return this.drawShape(new ee(e, t, n, r, i), a), this;
	}
	drawShape(e, t) {
	...
	startPoly(e, t) {
		...
		return n && this.endPoly(), n = new F(), n.points.push(e, t), this._currentPoly = n, this;
	}
	endPoly(e = !1) {
	...
	_ensurePoly(e = !0) {
		if (!this._currentPoly && (this._currentPoly = new F(), e)) {
	...
	get bounds() {
		...
		for (let n = 0; n < t.length; n++) {
			let r = t[n], i = r.shape.getBounds(Qe);
	...
	constructor(e, t = !1) {
		this.instructions = [], this.uid = d("graphicsPath"), this._dirty = !0, this.checkForHoles = t, typeof e == "string" ? k(e, this) : this.instructions = e?.slice() ?? [];
	}
	get shapePath() {
		return this._shapePath ||= new $e(this), this._dirty && (this._dirty = !1, this._shapePath.buildPath()), this._shapePath;
	}
	addPath(e, t) {
	...
	transform(e) {
		...
		for (let g = 0; g < this.instructions.length; g++) {
			...
			switch (_.action) {
				...
				default:
					h("unknown transform action", _.action);
					break;
			}
		}
...
function tt(e) {
	let t = new V(Z(e, "x1", 0), Z(e, "y1", 0), Z(e, "x2", 1), Z(e, "y2", 0), (e.getAttribute("gradientUnits") || "objectBoundingBox") === "objectBoundingBox" ? "local" : "global");
	for (let n = 0; n < e.children.length; n++) {
		let r = e.children[n], i = Z(r, "offset", 0), a = _.shared.setValue(r.getAttribute("stop-color")).toNumber();
		t.addColorStop(i, a);
	}
	return t;
}
function nt(e) {
	return h("[SVG Parser] Radial gradients are not yet supported"), new V(0, 0, 1, 0);
}
//#endregion
...
function dt(e, t) {
	...
	et(e, n);
	let r = e.children, { fillStyle: i, strokeStyle: a } = at(e, n);
	for (let e = 0; e < r.length; e++) {
		let t = r[e];
		t.nodeName.toLowerCase() !== "defs" && ft(t, n, i, a);
	}
	return t;
}
function ft(e, t, n, r) {
	let i = e.children, { fillStyle: a, strokeStyle: o } = at(e, t);
	a && n ? n = {
		...n,
		...a
	} : a && (n = a), o && r ? r = {
	...
	switch (e.nodeName.toLowerCase()) {
		case "path": {
			S = e.getAttribute("d");
			let i = e.getAttribute("fill-rule"), a = ct(S), o = i === "evenodd", s = a.length > 1;
			if (o && s) {
				let e = a.map((e) => ({
					path: e,
					area: lt(e)
				}));
				if (e.sort((e, t) => t.area - e.area), a.length > 3 || !st(e)) for (let i = 0; i < e.length; i++) {
					let a = e[i], o = i === 0;
					t.context.beginPath();
					let s = new Y(void 0, !0);
					ut(a.path, s), t.context.path(s), o ? (n && t.context.fill(n), r && t.context.stroke(r)) : t.context.cut();
				}
				else for (let i = 0; i < e.length; i++) {
					let a = e[i], o = i % 2 == 1;
					t.context.beginPath();
					let s = new Y(void 0, !0);
					ut(a.path, s), t.context.path(s), o ? t.context.cut() : (n && t.context.fill(n), r && t.context.stroke(r));
				}
			} else C = new Y(S, i ? i === "evenodd" : !0), t.context.path(C), n && t.context.fill(n), r && t.context.stroke(r);
			break;
		}
		case "circle":
			m = Z(e, "cx", 0), g = Z(e, "cy", 0), _ = Z(e, "r", 0), t.context.ellipse(m, g, _, _), n && t.context.fill(n), r && t.context.stroke(r);
			break;
		case "rect":
			...
			break;
		case "ellipse":
			m = Z(e, "cx", 0), g = Z(e, "cy", 0), v = Z(e, "rx", 0), y = Z(e, "ry", 0), t.context.beginPath(), t.context.ellipse(m, g, v, y), n && t.context.fill(n), r && t.context.stroke(r);
			break;
		case "line":
	...
	s && (n = null);
	for (let e = 0; e < i.length; e++) ft(i[e], t, n, r);
}
//#endregion
...
var mt = {
	...
	constructor(e, t) {
		...
		let r = n.repetition;
		r && (this.texture.source.style.addressModeU = mt[r].addressModeU, this.texture.source.style.addressModeV = mt[r].addressModeV);
	}
	setTransform(e) {
		if (e) {
...
function Q(e, t) {
	...
	let n = {}, r = e;
	return gt(e) ? bt(n, e, t) : yt(e) ? xt(n, e, t) : _t(e) ? St(n, e, t) : vt(e) ? Ct(n, e, t) : r.fill && _t(r.fill) ? St(r, r.fill, t) : r.fill && vt(r.fill) ? Ct(r, r.fill, t) : wt(r, t);
}
function Tt(e, t) {
	let { width: n, alignment: r, miterLimit: i, cap: a, join: o, pixelLine: s, ...c } = t, l = Q(e, c);
	return l ? {
		width: n,
		alignment: r,
		miterLimit: i,
...
var Dt = new r(), Ot = new o(), $ = class e extends s {
	...
	set fillStyle(t) {
		this._fillStyle = Q(t, e.defaultFillStyle);
	}
	get strokeStyle() {
		return this._strokeStyle;
	}
	set strokeStyle(t) {
		this._strokeStyle = Tt(t, e.defaultStrokeStyle);
	}
	setFillStyle(t) {
		return this._fillStyle = Q(t, e.defaultFillStyle), this;
	}
	setStrokeStyle(t) {
		return this._strokeStyle = Q(t, e.defaultStrokeStyle), this;
	}
	texture(e, t, n, r, i, a) {
		return this.instructions.push({
			action: "texture",
	...
	fill(t, n) {
		...
		return r = this._tick === 0 && i?.action === "stroke" ? i.data.path : this._activePath.clone(), r ? (t != null && (n !== void 0 && typeof t == "number" && (a(f, "GraphicsContext.fill(color, alpha) is deprecated, use GraphicsContext.fill({ color, alpha }) instead"), t = {
			color: t,
			alpha: n
		}), this._fillStyle = Q(t, e.defaultFillStyle)), this.instructions.push({
			action: "fill",
			data: {
	...
	stroke(t) {
		...
		return n = this._tick === 0 && r?.action === "fill" ? r.data.path : this._activePath.clone(), n ? (t != null && (this._strokeStyle = Tt(t, e.defaultStrokeStyle)), this.instructions.push({
			action: "stroke",
			data: {
	...
	svg(e) {
		return this._tick++, dt(e, this), this;
	}
	restore() {
	...
	transform(e, t, n, r, i, a) {
		return e instanceof o ? (this._transform.append(e), this) : (Ot.set(e, t, n, r, i, a), this._transform.append(Ot), this);
	}
	translate(e, t = e) {
	...
	get bounds() {
		...
		for (let t = 0; t < this.instructions.length; t++) {
			...
			if (r === "stroke") {
				...
				t.style.join === "miter" && (i *= Et(t.path, t.style.miterLimit));
				let a = t.path.bounds;
	...
	containsPoint(e) {
		...
		for (let r = 0; r < t.length; r++) {
			...
			for (let t = 0; t < c.length; t++) {
				let r = c[t].shape;
				if (!s || !r) continue;
				let o = c[t].transform, l = o ? o.applyInverse(e, Dt) : e;
...
var kt = $;
//#endregion
export { W as a, V as c, ht as i, de as l, Q as n, H as o, Tt as r, we as s, kt as t, ie as u };
