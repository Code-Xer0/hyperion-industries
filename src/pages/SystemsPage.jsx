      ...
      <section className="section section-alt">
        <div className="shell">
          ...
          <div className="sp-grid-2">
            {primary.map((sys) => {
              const originalIndex = systems.findIndex(s => s.id === sys.id);
              return (
                <HoverEditor key={sys.id} model="systems" index={originalIndex}>
                  <article className="sp-system-card">
        ...
        <div className="shell">
          ...
          <div className="sp-grid-3">
            {secondary.map((sys) => {
              ...
              return (
                <HoverEditor key={sys.id} model="systems" index={originalIndex}>
                  <article className="sp-lane-card">
                    <div className="sp-sys-head">
                      <img src={sys.icon} alt="" />
                      <div>
                        <h3>{sys.name}</h3>
