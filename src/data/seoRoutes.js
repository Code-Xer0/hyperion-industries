...
const fixedRoutes = [
  ...
  {
    path: '/card-studio/legacy',
    title: 'Card Studio Legacy Preview | Hyperion Industries',
    description: 'Legacy Card Studio parity surface retained temporarily for design comparison. Ordering is not available.',
    summary: 'A noindex compatibility preview for the retired standalone Card Studio runtime.',
    maturity: 'LEGACY PREVIEW · NO CHECKOUT',
    schemaType: 'WebPage',
    indexable: false,
    sourceFiles: ['public/assets/card-studio/runtime.html'],
    relatedPaths: ['/card-studio'],
  },
  {
    path: '/contact',
