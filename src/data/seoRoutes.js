...
const fixedRoutes = [
  ...
  },
  {
    ...
    schemaType: 'CollectionPage',
    sourceFiles: ['src/pages/StorePage.jsx', 'src/data/commercialOffers.js'],
    relatedPaths: ['/forge', '/card-studio', '/chronos', '/services'],
  },
  {
    path: '/services',
    ...
    schemaType: 'Service',
    aliases: ['/live-site-series'],
    sourceFiles: ['src/pages/ServicesPage.jsx', 'src/data/commercialOffers.js'],
    relatedPaths: ['/intake/live-sites', '/build-archive', '/contact'],
  },
  {
    path: '/founders',
