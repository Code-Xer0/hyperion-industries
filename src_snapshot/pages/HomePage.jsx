          ...
          <div className="hero-grid">
            <div className="hero-copy">
              ...
              <div className="hero-chips">
                <div className="chip"><span className="chip-name c">CHR0N.OS</span><span className="chip-status">Stable beta</span></div>
                <div className="chip"><span className="chip-name r">Mnem.OS</span><span className="chip-status">In development</span></div>
                <div className="chip"><span className="chip-name p">LOG.OS</span><span className="chip-status">Concept</span></div>
                <div className="chip"><span className="chip-name g">MYTH.OS</span><span className="chip-status">Research</span></div>
              </div>
            </div>
